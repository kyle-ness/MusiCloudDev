...
namespace MusiCloud.Controllers
{
    public class ArtistsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,First_Name,Last_Name")] Artist artist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,First_Name,Last_Name")] Artist artist)
        {
            if (id != artist.Id)
            {
                return NotFound();
