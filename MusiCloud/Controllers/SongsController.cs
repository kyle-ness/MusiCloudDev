...
namespace MusiCloud.Controllers
{
    public class SongsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CounterPlayed,LinkToPlay,AlbumId,SearchTerm")] Song song)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,CounterPlayed,LinkToPlay,AlbumId,SearchTerm")] Song song)
        {
            if (id != song.Id)
            {
                return NotFound();
