...
namespace MusiCloud.Controllers
{
    public class ConcertsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ArtistId,StreetLocation")] Concert concert)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ArtistId,StreetLocation")] Concert concert)
        {
            if (id != concert.Id)
            {
                return NotFound();
